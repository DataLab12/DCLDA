...
def add_ground_truth_to_proposals(
    ...
    #print("$$$ Len for proposals: ",len(proposals)," $$$ Len for GT: ", len(gt))
...
def add_ground_truth_to_proposals_single_image(
    ...
    #print("Final new proposals: ",new_proposals)

    return new_proposals # Returns proposals boxes [2000 + GT_boxes] and Objectness_logits [2000 + GT_boxes]
